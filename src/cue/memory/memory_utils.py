...
def load_from_memory(full_path: str, model: ChatModel = None):
    ...
    system_message = MessageParam(role="system", content="You're a helpful assistant!")
...
def save_to_memory(path, data: Dict):
    try:
